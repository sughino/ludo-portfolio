...
export const works: Work[] = [
  ...
  { title: 'polveri sottili', img: '/works/polveriSottili/main.webp', description: 'An environmental monitoring tool that tracks air quality and pollution levels.', width: 1280, height: 665, color: 'gray' },
  { title: 'donisi', img: '/works/donisi/main.webp', description: 'Modern landing page design for a professional plumbing company.', width: 1280, height: 665, color: 'red' },
  { title: 'mentecorpo', img: '/works/mentecorpo/main.webp', description: 'Minimal and calming showcase website designed for a professional psychologist.', width: 1280, height: 665, color: 'light-red' }
]